...
$student_email = $student_data['email'] ?? ''; // Use null coalescing operator for safety
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-1">
                                            <div class="col-sm-3 mb-2">
                                                ...
                                                <input type="date" class="form-control" id="birthdate" name="birthdate" value="<?php echo htmlspecialchars($decrypted_birthdate); ?>">
                                            </div>
                                            <div class="col-sm-4 mb-2">
