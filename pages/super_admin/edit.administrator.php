    ...
    switch ($_GET['alert']) {
        case 'success':
            $alert_message = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                <strong>Success!</strong> The administrator information has been updated.
        ...
        case 'error':
            $alert_message = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>Error!</strong> There was a problem updating the administrator information.
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                              </div>';
                            ...
                            <div class="card">
                                <form action="userData/ctrl.edit.administrator.php?admin_id=<?php echo $admin_id; ?>" enctype="multipart/form-data" method="POST">
                                                ...
                                                <div class="form-group mr-auto ml-auto col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <button type="submit" name="upload" class="btn bg-primary btn-default input-group-text">
                                                                Update
                                                            </button>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary btn-sm float-right ml-2" name="submit">Submit</button>
                                    </div>
                                </form>
                                <!-- /.card-footer -->
                            </div>
